...
// BEGIN INLINE /common/water_blocks_vertex.glsl
...
// BEGIN INLINE /src/position_vertex_water.glsl
...
#endif
// END INLINE /src/position_vertex_water.glsl
...
// END INLINE /src/shadow_src_vertex.glsl
    ...
    #if (V_CLOUDS != 0 && !defined UNKNOWN_DIM) && !defined NO_CLOUDY_SKY
// BEGIN INLINE /lib/volumetric_clouds_vertex.glsl
#if MC_VERSION >= 11300
...
// END INLINE /lib/volumetric_clouds_vertex.glsl
    #endif
}
// END INLINE /common/water_blocks_vertex.glsl
